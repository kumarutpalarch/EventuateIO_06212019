...
public class TodoCreated implements DomainEvent {
  ...
  public TodoCreated(String policyRequestor, String policyType, Date policyEffectiveDate,
			Date policyExpirationDate, String policyDetails) throws ParseException {
    /*this.title = title;
