    ...
    return DomainEventHandlersBuilder
            ...
            .onEvent(TodoCreated.class, dee -> {
              ...
              todoViewService.index(new TodoView(dee.getAggregateId(),
                  todoCreated.getPolicyRequestor(), todoCreated.getPolicyType(), todoCreated.getPolicyEffectiveDate(), todoCreated.getPolicyExpirationDate(), todoCreated.getPolicyDetails()));
            })
